...
rem set QT_CFG=%QT_CFG% -release
set QT_CFG=%QT_CFG% -static

rem debug build
rem https://groups.google.com/forum/#!topic/phantomjs/qgcpXILe-_0
set QT_CFG=%QT_CFG% -debug
set QT_CFG=%QT_CFG% -D QT_NODLL
set QT_CFG=%QT_CFG% -D QT_STATIC_BUILD
set QT_CFG=%QT_CFG% -D Q_DECL_IMPORT
...
set OPEN_SSL_DIR=E:\phantomjs\openssl
